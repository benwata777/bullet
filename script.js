...
//     ctx.fillRect(bullet.x, bullet.y, 5, 5); // ขนาดของกระสุน
//   }
// }

// // อัปเดตตำแหน่งและเฟรมแอนิเมชันของตัวละคร
// function update() {
//   player.moving = false;
...
//     // คำนวณทิศทางของกระสุนไปยังตัวละคร
...
// // ปรับความเร็วของกระสุนและการยิงกระสุนตามเวลา
// function adjustDifficulty() {
//   const elapsedTime = Math.floor((Date.now() - startTime) / 1000); // เวลาผ่านไปเป็นวินาที
//   if (elapsedTime % 10 === 0 && elapsedTime !== 0) {
//     // ทุก 10 วินาที
//     bulletSpeed += 0.5; // เพิ่มความเร็วของกระสุน
//     bulletInterval = Math.max(500, bulletInterval - 100); // ลดเวลาระหว่างการยิงกระสุน (ขั้นต่ำ 500 มิลลิวินาที)
//     bulletsPerInterval++; // เพิ่มจำนวนกระสุนที่ยิงออกไป
//   }
// }

// // สร้างกระสุนตามช่วงเวลา
// setInterval(() => {
//   shootBullet();
//   adjustDifficulty();
// }, bulletInterval);

// // จับการกดปุ่มเพื่อควบคุมการเคลื่อนที่ของตัวละคร
// let keys = {
//   ArrowUp: false,
//   ArrowDown: false,
//   ArrowLeft: false,
...
// // จับการปล่อยปุ่มเพื่อหยุดการเคลื่อนที่
...
// // เริ่มเกม
// gameLoop();
// updateScoreDisplay(); // แสดงคะแนนปัจจุบัน
// updateHighScoreDisplay(); // แสดงคะแนนสูงสุดเริ่มต้น
const canvas = document.getElementById("gameCanvas");
const ctx = canvas.getContext("2d");
